                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <x-inputs.text-input id="name" class="mt-2 w-full" name="name" type="text" :value="old('name', $user->name)" autofocus placeholder="{{ __('Name') }}" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-inputs.text-input id="email" class="mt-2 w-full" name="email" type="email" :value="old('email', $user->email)" placeholder="{{ __('Email') }}" />
